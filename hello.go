...
func main() {
	...
	fmt.Println("")
	fmt.Println("		+-----------------------------------+")
	fmt.Println("		| +--->  ARRIVE AT FLOOR :", 1, " <---+ |")
	fmt.Println("		+-----------------------------------+")
	fmt.Println("")
	fmt.Println("		+------------------------------------+")
	fmt.Println("		| +--->  ARRIVE AT FLOOR :", 22, " <---+ |")
	fmt.Println("		+------------------------------------+")
	fmt.Println("")
	fmt.Println("		+-------------------------------------+")
	fmt.Println("		| +--->  ARRIVE AT FLOOR :", 333, " <---+ |")
	fmt.Println("		+-------------------------------------+")
	fmt.Println("")
	fmt.Println("		+------------------------------------+")
	fmt.Println("		| +--->         REQUEST        <---+ |")
	fmt.Println("		| |                                | |")
	fmt.Println("		| |        AT FLOOR:", 1, "            | |")
	fmt.Println("		| |        FLOOR REQUESTED:", 1, "     | |")
	...
	fmt.Println("		| +--->         REQUEST        <---+ |")
	fmt.Println("		| |                                | |")
	fmt.Println("		| |        AT FLOOR:", 22, "           | |")
	fmt.Println("		| |        FLOOR REQUESTED:", 22, "    | |")
	fmt.Println("		| |        DIRECTION:", "UP", "          | |")
	fmt.Println("		| |                                | |")
	fmt.Println("		| +--->                        <---+ |")
	fmt.Println("		+------------------------------------+")
	...
	fmt.Println("		| |                          | |")
	fmt.Println("		| |        ID:", 333, "          | |")
	fmt.Println("		| |        Floor:", 333, "       | |")
	fmt.Println("		| |        Status:", "IDLE", "     | |")
	fmt.Println("		| |        Next-Stop", 333, "    | |")
	fmt.Println("		| |                          | |")
	fmt.Println("		| +--->                  <---+ |")
	fmt.Println("		+------------------------------+")
	fmt.Println("")
	...
	fmt.Println("		| |                          | |")
	fmt.Println("		| |        ID:", 22, "           | |")
	fmt.Println("		| |        Floor:", 22, "        | |")
	fmt.Println("		| |        Status:", "IDLE", "     | |")
	fmt.Println("		| |        Next-Stop", 22, "     | |")
	fmt.Println("		| |                          | |")
	fmt.Println("		| +--->                  <---+ |")
	fmt.Println("		+------------------------------+")
	fmt.Println("")
